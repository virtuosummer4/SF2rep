...
% PY4DESC decode the original mage from a 3-layer Laplacian pyramid.
...
figure;
draw(beside(Z0,beside(X,beside(Z1,beside(X1,beside(Z2,beside(X2,beside(Z3,beside(X3,X4)))))))));
